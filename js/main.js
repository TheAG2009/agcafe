...
const menuItems = [
    ...
    // Idli & Vada
    { id: 7, name: 'Idli (2 pcs)', description: 'Soft rice cakes', price: 40, image: 'https://images.unsplash.com/photo-1630384060421-cb20d0e0649d?w=400' },
    ...
    { id: 9, name: 'Medu Vada (2 pcs)', description: 'Crispy lentil donuts', price: 50, image: 'https://images.unsplash.com/photo-1630384060421-cb20d0e0649d?w=400' },
    ...
    { id: 15, name: 'Samosa (2 pcs)', description: 'Crispy potato samosa', price: 30, image: 'https://images.unsplash.com/photo-1601050690597-df0568f7a1f1?w=400' },
    ...
    { id: 27, name: 'Paneer Chilli', description: 'Crispy paneer in chilli sauce', price: 95, image: 'https://images.unsplash.com/photo-1585032226651-759b368d7246?w=400' },
    ...
    // Desserts
    { id: 38, name: 'Gulab Jamun (2 pcs)', description: 'Soft milk solids in syrup', price: 35, image: 'https://images.unsplash.com/photo-1589119908995-c6837a148b2b?w=400' },
    { id: 39, name: 'Jalebi (4 pcs)', description: 'Crispy spiral sweet', price: 40, image: 'https://images.unsplash.com/photo-1589119908995-c6837a148b2b?w=400' },
    ...
    { id: 49, name: 'Green Tea', description: 'Healthy green tea', price: 25, image: 'https://images.unsplash.com/photo-1579632652768-453cb5f7f6b9?w=400' },
